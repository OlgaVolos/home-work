...
// //     return max;
// // }
// // console.log(returnMax(32, 55, 40));
//
...
// }
//
// console.log(changeArr([1, 0, 6, 0, 3]));
//
...
// // **- функція приймає 2 масиви з рівною кількістю об'єктів та з'єднює
// // в один об'єкт користувача та місто з відповідними "id" та "user_id",
...
// // const arr = [1,3, ['Hello, 'Wordd', [9,6,1]], ['oops'], 9] -> [1, 3, 'Hello, 'Wordd', 9, 6, 1, 'oops', 9];
// // arr.flat(3);
// // console.log(arr);
// // // ===========додаткове========
...
//     return max;
// }
// console.log(arrMax([12,1,2,9,'hhdd']));
...
//     let min = array[0];
//     for (const item of array) {
//         if (item<min && typeof item === 'number'){
//             min = item;
//         }
//
//     }
...
//     return min
// };
// console.log(arrMin([12, 4, 54, "545454"]));
...
//     return counter
// }
// const arra = [{u: 'hhf'}, {hhf: 12}, 12, ['jfjfhjgjg'], 'jfjf'];
...
// return sum
// }
// const num3 = sumator(num1,num2);
// console.log(num3);
// - *** приймає масив та число "i", та міняє місцями об`єкт який знаходиться в індексі "i" на "i+1"

// function changeArr(array, i) {
//     const arr = [...array];
//     if(i<arr.length){
//       let item = arr[i];
//       arr[i] = arr[i+1];
...
// }
//
// console.log(changeArr([1, 2, 3, 5, 6], 2));
