...
// const myAge = 33;
// const myAddress = 27;
// const myApartment = 10;
// const myName = 'Olya';
// const mySurname = 'Volos'
// const myLastName = 'Igorivna'
...
// let persone = (name + ' ' + surname + ' ' + lastname);

// document.write(persone);

// при помощи prompt() получить 3 числа. Привести их к числовому типу при помощи +. вывести их в консоль.
// let number1 = prompt( 'Show a number');
// console.log (+number1);
// document.write(+number1);

// let number2 = prompt('Show a number');
// console.log(+number2);

// let number3 = prompt( 'Show a number');
// console.log (+number3);
...
// console.log(a3)
//
// let a4 = prompt('Ввести значення а4');
// a4 = parseInt(a4);
// console.log(a4)
//
...
// let a = Math.floor(prompt("Введіть число", "2,5"));
// let b = Math.floor(prompt("Введіть число", "2,5"));
// let c = Math.pow(a, b);
// console.log(c)
...
let str = "20"; // стрінга
 let a = 5; // число
 document.write(str + a + "<br/>"); // 205, бо js сприймає число в стрінзі, як число і лише з + конкетинує, решту дій сприймає к дії між числами
...
// let color = prompt('Введіть колір', 'зелений, жовтий, червоний')
// if (color === 'зелений') {
//     alert('Йди!');
...
// let isRoadClear = confirm('Є машини?');
// let color = prompt('Введіть колір', 'зелений, жовтий, червоний')

// if (isRoadClear === false && color === 'зелений') {
//     alert('иди');
// } else if (isRoadClear === true && color === 'зелений') {
